  ...
  if(WIN32)
    if(MSVC_VERSION GREATER_EQUAL 1900)
      if(CMAKE_SIZEOF_VOID_P EQUAL 8)
        ...
        list(APPEND ODAMEX_DLLS "${WX_DLL_DIR}/wxbase32ud_net_vc14x_x64.dll")
        list(APPEND ODAMEX_DLLS "${WX_DLL_DIR}/wxbase32ud_vc14x_x64.dll")
        list(APPEND ODAMEX_DLLS "${WX_DLL_DIR}/wxbase32ud_xml_vc14x_x64.dll")
        list(APPEND ODAMEX_DLLS "${WX_DLL_DIR}/wxmsw32ud_core_vc14x_x64.dll")
        list(APPEND ODAMEX_DLLS "${WX_DLL_DIR}/wxmsw32ud_html_vc14x_x64.dll")
        list(APPEND ODAMEX_DLLS "${WX_DLL_DIR}/wxmsw32ud_xrc_vc14x_x64.dll")
      else()
