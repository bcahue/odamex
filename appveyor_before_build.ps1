...
7z x "wxWidgets-3.1.3.zip" -o*
& "C:\Program Files (x86)\cmake\bin\cmake.exe" .\wxWidgets-3.1.3 -G "MinGW Makefiles" -DwxBUILD_COMPATIBILITY="2.8" -DCMAKE_BUILD_TYPE=Release -DwxBUILD_SHARED=False -DCMAKE_SH="CMAKE_SH-NOTFOUND" -DCMAKE_CXX_COMPILER="C:/mingw-w64/x86_64-8.1.0-posix-seh-rt_v6-rev0/bin/g++.exe" -DCMAKE_C_COMPILER="C:/mingw-w64/x86_64-8.1.0-posix-seh-rt_v6-rev0/bin/gcc.exe"
& "C:\Program Files (x86)\cmake\bin\cmake.exe" --build .\wxWidgets-3.1.3
& "C:\Program Files (x86)\cmake\bin\cmake.exe" .. -G "MinGW Makefiles" -DUSE_MINIUPNP=False -DSDL2_INCLUDE_DIR="./SDL2-2.0.5/include/" -DSDL2_LIBRARY="./SDL2-2.0.5/lib/x86/SDL2.lib" -DSDL2MAIN_LIBRARY="./lib/x86/SDL2main.lib" -DSDL2_MIXER_INCLUDE_DIR="./SDL2_mixer-2.0.1/include/" -DSDL2_MIXER_LIBRARY="./SDL2_mixer-2.0.1/lib/x86/SDL2_mixer.lib" -DUSE_STATIC_STDLIB=True -DwxWidgets_wxrc_EXECUTABLE="./wxWidgets-3.1.3/lib/gcc_lib/wxrc.exe" -DCMAKE_SH="CMAKE_SH-NOTFOUND" -DCMAKE_CXX_COMPILER="C:/mingw-w64/x86_64-8.1.0-posix-seh-rt_v6-rev0/bin/g++.exe" -DCMAKE_C_COMPILER="C:/mingw-w64/x86_64-8.1.0-posix-seh-rt_v6-rev0/bin/gcc.exe"
